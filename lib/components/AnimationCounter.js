  ...
  _createClass(AnimationCounter, [{
    ...
    value: function componentDidMount() {
      ...
      if (this.props.count > 0) {
        (function () {
          var badge = _reactDom2.default.findDOMNode(_this2.refs.badge);
          badge.style['-moz-transform'] = badge.style['-webkit-transform'] = badge.style['-o-transform'] = badge.style['-ms-transform'] = badge.style.transform = _this2.props.effect[0];
          if (_this2.props.effect[2]) {
            _this2.attachStyle(badge, _this2.props.effect[2]);
          }
          setTimeout(function () {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.count > prevProps.count) {
        (function () {
          var badge = _reactDom2.default.findDOMNode(_this3.refs.badge);
          badge.style['-moz-transform'] = badge.style['-webkit-transform'] = badge.style['-o-transform'] = badge.style['-ms-transform'] = badge.style.transform = _this3.props.effect[0];
          if (_this3.props.effect[2]) {
            _this3.attachStyle(badge, _this3.props.effect[2]);
          }
          setTimeout(function () {
            badge.style['-moz-transform'] = badge.style['-webkit-transform'] = badge.style['-o-transform'] = badge.style['-ms-transform'] = badge.style.transform = _this3.props.effect[1];
            if (_this3.props.effect[3]) {
              _this3.attachStyle(badge, _this3.props.effect[3]);
            }
